...
async function monte_carlo_calculate()
{
    ...
    document.getElementById("circlet1").innerHTML = (TryCount/AfPartsNum[0]).toFixed(1) + "個";
    document.getElementById("circlet2").innerHTML = (TryCount/AfPartsNum[1]).toFixed(1) + "個";
    document.getElementById("circlet3").innerHTML = (2 * TryCount/AfPartsNum[2]).toFixed(1) + "個";
    document.getElementById("circlet4").innerHTML = (4 * TryCount/AfPartsNum[3]).toFixed(1) + "個";
    document.getElementById("circlet5").innerHTML = (3 * TryCount/AfPartsNum[4]).toFixed(1) + "個";
