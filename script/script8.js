...
async function monte_carlo_calculate()
{
    ...
    document.getElementById("circlet1").innerHTML = (1 - (1 -AfPartsNum[0] / TryCount) ** 12).toFixed(1) + "％";
    document.getElementById("circlet2").innerHTML = (1 - (1 -AfPartsNum[1] / TryCount) ** 12).toFixed(1) + "％";
    document.getElementById("circlet3").innerHTML = (1 - (1 -AfPartsNum[2] / TryCount) ** 6).toFixed(1) + "％";
    document.getElementById("circlet4").innerHTML = (1 - (1 -AfPartsNum[3] / TryCount) ** 3).toFixed(1) + "％";
    document.getElementById("circlet5").innerHTML = (1 - (1 -AfPartsNum[4] / TryCount) ** 4).toFixed(1) + "％";
