...
function af30_2()
{
    let checkbox = document.getElementById("af30_2");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked)
    {
        status_buff = [0, 0, 0, 0, 0.18, 0, 0, 0]; 
...
{
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    const buff_check1 = document.getElementById("af30_4");
    let dmg_buff = 0
    if (buff_check1.checked)
    {
        const buff_count = parseInt(document.getElementById("af30-4List").value);
        dmg_buff = buff_count * 0.18;
    }
    status_buff = [0, 0, 0, 0, 0, 0, 0, dmg_buff]; 
    return status_buff;
}

function af31_2()
{
    let checkbox = document.getElementById("af31_2");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked)
    {
        status_buff = [0, 0, 0, 0, 0.18, 0, 0, 0]; 
...
{
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    const buff_check1 = document.getElementById("af31_4");
    let dmg_buff = 0
    if (buff_check1.checked)
    {
        dmg_buff = parseInt(document.getElementById("af31_4List").value) / 100;
    }
    status_buff = [0, 0, 0, 0, 0, 0, 0, dmg_buff]; 
    return status_buff;
}
...
{
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    const buff_list = [0,0.12,0.4];
    const buff_check1 = document.getElementById("af32_4");
    let dmg_buff = 0
    if (buff_check1.checked)
    {
        const buff_count = parseInt(document.getElementById("af32_4select").value)
        dmg_buff = buff_list[buff_count];
    }
    status_buff = [0, 0, 0, 0, 0, 0, 0, dmg_buff]; 
    return status_buff;
}
...
function af33_2()
{
    let checkbox = document.getElementById("af33_2");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked)
    {
        status_buff = [0, 0, 0, 0, 0, 0, 0, 0.15]; 
...
{
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    const buff_check1 = document.getElementById("af33_4");
    let cr_buff = 0
    if (buff_check1.checked)
    {
        cr_buff = 0.4
...
const set_effect2 = [af0_2, af1_2, af2_2, af3_2, af4_2, af5_2, af6_2, af7_2, af8_2, af9_2, af10_2,
                     ...
                     af21_2, af22_2, af23_2, af24_2, af25_2, af26_2, af27_2, af28_2, af29_2, af30_2,
                     af31_2, af32_2, af33_2
                    ];
...
const set_effect4 = [af0_4, af1_4, af2_4, af3_4, af4_4, af5_4, af6_4, af7_4, af8_4, af9_4, af10_4,
                     ...
                     af21_4, af22_4, af23_4, af24_4, af25_4, af26_4, af27_4, af28_4, af29_4, af30_4,
                     af31_4, af32_4, af33_4
                    ];