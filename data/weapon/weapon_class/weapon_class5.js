  ...
  class UrakuMisugiri {
    ...
    calculate_weapon_fixed_deff(fixstatus,status) {
      return this.base_status_array[1] * 0.05 * (WeaponConstellations + 3);
    }
    ...
    calculate_weapon_fixed_dmg_buff(fixstatus,status) {
      ...
      if (attack_method_index == 0)
      {
        dmg_buff = 0.04 * (WeaponConstellations + 3) * buff_effect;
      }
      else if (attack_method_index == 3)
      {
        dmg_buff = 0.06 * (WeaponConstellations + 3) * buff_effect;
      }
      return dmg_buff;
    }
  ...
  class Absolution {
    ...
    calculate_weapon_fixed_cd(fixstatus,status) {
      return 0.05 * (WeaponConstellations + 3);
    }
    ...
    calculate_weapon_fixed_dmg_buff(fixstatus,status) {
      ...
      dmg_buff = buff_count * 0.04 * (WeaponConstellations + 3);
      return dmg_buff;
    }
  ...
  class SurfsUp {
    ...
    calculate_weapon_fixed_hp(fixstatus,status) {
      return this.base_status_array[0] * 0.05 * (WeaponConstellations + 3);
    }
    ...
    calculate_weapon_fixed_dmg_buff(fixstatus,status) {
      ...
      if (attack_method_index == 0)
      {
        ...
        dmg_buff = buff_count * 0.03 * (WeaponConstellations + 3);
      }
      return dmg_buff;
    }
  ...
  class FluteOfEzpitzal {
    ...
    calculate_weapon_fixed_deff(fixstatus,status) {
      ...
      if (buff_check.checked)
      {
        deff_buff = this.base_status_array[1] * 0.04 * (WeaponConstellations + 3);
      }
      return deff_buff;
    }
  ...
  class EarthShaker {
    ...
    calculate_weapon_fixed_dmg_buff(fixstatus,status) {
      ...
      {
        buff_effect = 0.04 * (WeaponConstellations + 3)
      }
      return dmg_buff;
    }
  ...
  class RingofYaxche {
    ...
    calculate_weapon_result_dmg_buff(fixstatus,status) {
      ...
      {
        dmg_buff = status[0] * (WeaponConstellations + 5) / 1000000;
        if (dmg_buff > 0.04 * (WeaponConstellations + 3))
        {
          dmg_buff = 0.04 * (WeaponConstellations + 3)
        }
      }
  ...
  class SilvershowerHeartstrings {
    ...
    calculate_weapon_fixed_hp(fixstatus,status) {
      ...
      let hp_buff = 0.03 * (WeaponConstellations + 3) * buff_count;
      if (buff_count == 3)
      {
        hp_buff += 0.01 * (WeaponConstellations + 3);
      }
  ...
  class StarcallersWatch {
    ...
    calculate_weapon_fixed_elm(fixstatus,status) {
      const elm_buff = 25 * (WeaponConstellations + 3);
      return elm_buff;
    }
    ...
    calculate_weapon_fixed_cd(fixstatus,status) {
      ...
      if (buffFlag.checked)
      {
        CdBuff = 0.07 * (WeaponConstellations + 3);
      }
      return CdBuff;
    }
