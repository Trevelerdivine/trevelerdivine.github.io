...
class LostPrayertotheSacredWinds {
  ...
  calculate_weapon_fixed_dmg_buff(fixstatus,status) {
    ...
    if (char_propaty[0] != 7)
    {
      dmg_buff = (this.weapon_rank + 3) * 0.02 * this.weapon_count * this.weapon_effect;
    }
    return dmg_buff
  }
...
class SacrificialJade {
  ...
  calculate_weapon_fixed_hp(fixstatus,status) {
    return 0.08 * (this.weapon_rank + 3) * this.buff_flag * this.base_status_array[0];
  }
  ...
  calculate_weapon_fixed_elm(fixstatus,status) {
    return 10 * (this.weapon_rank + 3) * this.buff_flag;
  }
...
class FlowingPurity {
  ...
  calculate_weapon_fixed_dmg_buff(fixstatus,status) {
    ...
    {
      dmg_buff = 0.02 * (this.weapon_rank + 3);
    }
    return dmg_buff;
  }

  calculate_weapon_result_dmg_buff(fixstatus,status) {
    return Math.min(0.03 * (this.weapon_rank + 3), this.effect_flag * status[0] * 0.24* 0.001 * 0.005 * (this.weapon_rank + 3));
  }
...
class FruitofFulfillment {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    return -0.05 * this.buff_count * this.base_status_array[4];
  }
  ...
  calculate_weapon_fixed_elm(fixstatus,status) {
    return 3 * (this.weapon_rank + 7) * this.buff_count;
  }
...
class OathswornEye {
  ...
  calculate_weapon_fixed_elm_charge(fixstatus,status) {
    return 0.06 * (this.weapon_rank + 3);
  }
...
class HakushinRing {
  ...
  calculate_weapon_fixed_dmg_buff(fixstatus,status) {
    ...
    if (buff_check.checked && char_propaty[0] != 7)
    {
      dmg_buff = 0.025 * (this.weapon_rank + 3);
    }
    return dmg_buff;
  }
...
class DodocoTales {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    ...
    if (buff_check.checked)
    {
      attack_buff = 0.02 * (this.weapon_rank + 3) * this.base_status_array[4];
    }
    return attack_buff;
  }
...
class BlackcliffAgate {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    ...
    return 0.03 * (this.weapon_rank + 3) * buff_count * this.base_status_array[4];
  }
...
class Verdict {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    return 0.05 * (this.weapon_rank + 3) * this.base_status_array[4];
  }
...
class UltimateTyrantSuperDevilSword {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    return 0.03 * (this.weapon_rank + 3) * 2  * this.base_status_array[4];
  }
...
class CashflowSupervision {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    return 0.04 * (this.weapon_rank + 3) * this.base_status_array[4];
  }
...
class Absolution {
  ...
  calculate_weapon_fixed_cd(fixstatus,status) {
    return 0.05 * (this.weapon_rank + 3);
  }
  ...
  calculate_weapon_fixed_dmg_buff(fixstatus,status) {
    let dmg_buff = 0
    let buff_count = parseInt(document.getElementById("dmg_buff_count").value);
    dmg_buff = buff_count * 0.04 * (this.weapon_rank + 3);
    return dmg_buff;
  }
...
class SurfsUp {
  ...
  calculate_weapon_fixed_hp(fixstatus,status) {
    return this.base_status_array[0] * 0.05 * (this.weapon_rank + 3);
  }
...
class FootprintoftheRainbow {
  ...
  calculate_weapon_fixed_deff(fixstatus,status) {
    let deff_buff = 0
    let buff_check = document.getElementById("FootprintoftheRainbow_effect");
    if (buff_check.checked)
    {
      deff_buff = this.base_status_array[1] * 0.04 * (this.weapon_rank + 3);
    }
...
class RingofYaxche {
  ...
  calculate_weapon_result_dmg_buff(fixstatus,status) {
    let dmg_buff = 0;
    const buff_check = document.getElementById("RingofYaxche_effect");
    if (buff_check.checked && attack_method_index == 0)
    {
      dmg_buff = status[0] * (this.weapon_rank + 5) / 1000000;
      if (dmg_buff > 0.04 * (this.weapon_rank + 3))
      {
        dmg_buff = 0.04 * (this.weapon_rank + 3)
      }
    }
...
class ChainBreaker {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    ...
    const atk_buff = this.base_status_array[4] * 0.012 * (this.weapon_rank + 3) * (buff_num1 + buff_num2);
    return atk_buff;
  }
...
class SilvershowerHeartstrings {
  constructor(base_status_array) {
    this.base_status_array = base_status_array;
    this.weapon_rank = parseInt(document.getElementById("weapon_rank").value);
  }
  ...
  calculate_weapon_fixed_hp(fixstatus,status) {
    let buff_count = parseInt(document.getElementById("SilvershowerHeartstrings_count").value);
    let hp_buff = 0.03 * (this.weapon_rank + 3) * buff_count;
    if (buff_count == 3)
    {
      hp_buff += 0.01 * (this.weapon_rank + 3);
    }
    return this.base_status_array[0] * hp_buff;
  }
...
class AThousandBlazingSuns {
  ...
  calculate_weapon_fixed_attck(fixstatus,status) {
    ...
    {
      attackBuff = 0.07 * (this.weapon_rank + 3) * this.base_status_array[4];
  ...
  calculate_weapon_fixed_cd(fixstatus,status) {
    ...
    if (BlazingSunsFlag.checked)
    {
      CdBuff = 0.05 * (this.weapon_rank + 3);
      const YakonFlag = document.getElementById("BlazingSuns_effect2");
      if (YakonFlag.checked)
      {
        CdBuff *= 1.75;
...
class StarcallersWatch {
  ...
  calculate_weapon_fixed_elm(fixstatus,status) {
    const elm_buff = 25 * (this.weapon_rank + 3);
    return elm_buff;
  }
  ...
  calculate_weapon_fixed_cd(fixstatus,status) {
    let CdBuff = 0;
    const buffFlag = document.getElementById("StarcallersWatch_effect");
    if (buffFlag.checked)
    {
      CdBuff = 0.07 * (this.weapon_rank + 3);
    }
    return CdBuff;
  }
