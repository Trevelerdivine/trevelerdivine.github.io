class nahida {
    ...
    async dmg_rate_data() {
      ...
      const dmg_elm_rate = data.元素スキル.数値.攻撃力[10];
    ...
    calculate_basic_dmg(dmg_rate) {
      return (this.result_status[1]*dmg_rate[1] + 
        result_status[3]*dmg_rate[3]+ 1807.5*(1 + 5 * this.result_status[3]/(this.result_status[3] + 1200)));
    }
