...
class alhaitham {
  ...
  async dmg_rate_data() {
    ...
    if (attack_method == 1) {
      ...
      const dmg_elm_rate1 = parseFloat(data["元素スキル"]["詳細"][1]["数値"][this.parameter[3]]) * attack_count1
      const dmg_attck_rate2 = parseFloat(data["元素スキル"]["詳細"][2]["数値"][this.parameter[3]]) * attack_count2;
